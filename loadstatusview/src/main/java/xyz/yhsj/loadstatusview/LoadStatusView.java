...
public class LoadStatusView extends FrameLayout {
    ...
    private LinearLayout llUndoCause;
    private TextView tvUndoCause;
    private TextView tvUndoCauseContent;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (loadingViewResId > -1) {
            ...
            tvLoading = (TextView) mLoadingView.findViewById(R.id.message_info);
            addView(mLoadingView, mLoadingView.getLayoutParams());
        ...
        if (emptyViewResId > -1) {
            ...
            tvEmpty = (TextView) mEmptyView.findViewById(R.id.message_info);
            addView(mEmptyView, mEmptyView.getLayoutParams());
        ...
        if (errorViewResId > -1) {
            ...
            tvError = (TextView) mErrorView.findViewById(R.id.message_info);
            llUndoCause = (LinearLayout) mErrorView.findViewById(R.id.ll_undo_cause);
            tvUndoCause = (TextView) mErrorView.findViewById(R.id.tv_undo_cause);
            tvUndoCauseContent = (TextView) mErrorView.findViewById(R.id.tv_undo_cause_content);
            addView(mErrorView, mErrorView.getLayoutParams());
     ...
     *
     * @param UndoCauseKey
     * @param UndoCauseContent 撤销原因
     */
    public void setViewUndoCause(String UndoCauseKey, String UndoCauseContent) {
        if (TextUtils.isEmpty(UndoCauseKey) || TextUtils.isEmpty(UndoCauseContent)) {
            llUndoCause.setVisibility(View.GONE);
        } else {
            tvUndoCause.setText(UndoCauseKey);
            tvUndoCauseContent.setText(UndoCauseContent);
     ...
     * @param boo
     */
    public void setLayout(boolean boo) {
        if (boo) {
            llUndoCause.setVisibility(View.VISIBLE);
        } else {
            llUndoCause.setVisibility(View.GONE);
        }
    }
