...
//                            List<PlanDetailsEntity> data = new ArrayList<>();
//                            for (PlanDetailsEntity planDetailsDate : returnData.getData()) {
//                                data.add(new PlanDetailsEntity(true, null, planDetailsDate));
