 ...
 * @date 2018/12/11
 */
public class PepaymentPlanListAdapter extends BaseQuickAdapter<PepaymentPlanList, BaseViewHolder> {

    public PepaymentPlanListAdapter() {
        super(R.layout.item_pepayment_plan_list);
    }

    @Override
    protected void convert(BaseViewHolder helper, PepaymentPlanList item) {
...
//        /*正常*/
//        QMUIProgressBar apbSchedule = helper.getView(R.id.apb_schedule);
//        /*异常*/
//        QMUIProgressBar apbAbnormalSchedule = helper.getView(R.id.apb_abnormal_schedule);
        /*获取进度控件*/
...
//            case "1":
//                qrrlPlanAbnormal.setVisibility(View.GONE);
//                apbAbnormalSchedule.setVisibility(View.GONE);
//                apbSchedule.setVisibility(View.VISIBLE);
//                break;
//            /*已完成*/
//            case "2":
//                qrrlPlanAbnormal.setVisibility(View.GONE);
...
//            case "4":
//                qrrlPlanAbnormal.setVisibility(View.VISIBLE);
//                apbSchedule.setVisibility(View.GONE);
//                break;
//            /*制定中*/
//            case "5":
//                qrrlPlanAbnormal.setVisibility(View.GONE);
...
//                qrrlPlanAbnormal.setVisibility(View.VISIBLE);
//                apbSchedule.setVisibility(View.GONE);
//                apbAbnormalSchedule.setVisibility(View.VISIBLE);
//                break;
//            /*未完全成功*/
//            case "7":
//                qrrlPlanAbnormal.setVisibility(View.GONE);
...
//                .setText(R.id.tv_number_remaining, "剩余" + StringUtil.getSubtract(item.getRepaymentNum(), item.getAlreadyRepaymentNum()) + "笔");
                .setText(R.id.tv_number_remaining, "剩余" + (TextUtils.isEmpty(StringUtil.getSubtract(item.getRepaymentNum(), item.getAlreadyRepaymentNum())) ? 0 :
                        /*判断还款笔数减去已还款笔数是否小于或等于0，如果小于等于0就把值设置为0，如果大于零则设置为计算的值*/
