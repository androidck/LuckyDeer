 ...
 * @date 2018/12/12
 */
public class ExecutePlanFragment extends BaseFragment {
    /**
     * 下啦刷新
     */
    ...
    public static ExecutePlanFragment newInstance(Bundle args) {
        ExecutePlanFragment fragment = new ExecutePlanFragment();
