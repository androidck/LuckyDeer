        ...
        public void onLocationChanged(AMapLocation location) {
            if (null != location) {
                ...
                if(location.getErrorCode() == 0){
                    ...
                    locationEntity.setArea(location.getDistrict());
                    locationEntity.setCity(location.getCity());
                    locationEntity.setAreaCode(location.getAdCode());
                    locationEntity.setProvince(location.getProvince());
                    locationEntity.setLongitude(location.getLongitude());
                    locationEntity.setLatitude(location.getLatitude());

                    String gson=new Gson().toJson(locationEntity);
                    setLocationResult(gson);
