package com.lucky.deer.find.business.view;
...
import com.lucky.deer.find.business.view.others.SimpleWeakObjectPool;
...
public class NineGridView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    public void OnClickListener(boolean isClick){
...
//        } else if (length <= 6) {
//            mRows = 2;
//            /*因为length <=6 所以实际Columns<3也是不会导致计算出问题的*/
//            mColumns = 3;
//            if (length == 4) {
//                mColumns = 2;
//            }
