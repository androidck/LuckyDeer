...
import com.lucky.deer.find.business.view.enums.TranslationState;
import com.lucky.deer.find.business.view.interfaces.OnItemClickPopupMenuListener;
import com.lucky.deer.find.business.view.interfaces.OnStartSwipeRefreshListener;
...
public class Utils {
    ...
    public static int dp2px(float dpValue) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpValue, MyApplication.context.getResources().getDisplayMetrics());
    }
